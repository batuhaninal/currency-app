...
{
    public record CurrencyHistoryItemResponse
    {
        public CurrencyHistoryItemResponse()
        {

        }

        public CurrencyHistoryItemResponse(int currencyHistoryId, int currencyId, decimal oldPurchasePrice, decimal newPurchasePrice, decimal oldSalePrice, decimal newSalePrice, DateOnly date, DateTime updatedDate)
        {
