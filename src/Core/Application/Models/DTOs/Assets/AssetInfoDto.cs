...
namespace Application.Models.DTOs.Assets
{
    public sealed record AssetInfoDto
    {
        ...
        public AssetInfoDto(int assetId, decimal count, decimal purchasePrice, decimal salePrice, decimal currentPurchasePrice, decimal currentSalePrice, DateOnly purchaseDate, DateTime createdDate, DateTime updatedDate, bool isActive, CurrencyRelationDto? currency = null, UserRelationDto? user = null)
        {
            AssetId = assetId;
            Count = count;
