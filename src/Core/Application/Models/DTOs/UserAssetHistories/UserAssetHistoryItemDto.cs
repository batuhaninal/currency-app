...
{
    public sealed record UserAssetHistoryItemDto
    {
        public UserAssetHistoryItemDto()
        {

        }

        public UserAssetHistoryItemDto(int userAssetHistoryId, DateOnly date, decimal totalPurchasePrice, decimal totalSalePrice, decimal totalCurrentPurchasePrice, decimal totalCurrentSalePrice, decimal totalCostPurchasePrice, decimal totalCostSalePrice, DateTime createdDate)
        {
