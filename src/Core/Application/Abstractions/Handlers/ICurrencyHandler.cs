...
namespace Application.Abstractions.Handlers
{
    public interface ICurrencyHandler
    {
        ...
        Task<IResult> AddTag(AddCurrencyTagCommand command, Dispatcher dispatcher, CancellationToken cancellationToken);
        Task<IResult> UpdateTag(UpdateCurrencyTagCommand command, Dispatcher dispatcher, CancellationToken cancellationToken);
        Task<IResult> DeleteTag(DeleteCurrencyTagCommand command, Dispatcher dispatcher, CancellationToken cancellationToken);
        ...
        Task<IResult> TagInfo(CurrencyTagInfoQuery query, Dispatcher dispatcher, CancellationToken cancellationToken);
        ...
        Task<IResult> Calculator(CalculatorQuery query, Dispatcher dispatcher, CancellationToken cancellationToken);
    }
}